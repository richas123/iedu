...
$r_url = $protocol . "://" . $_SERVER['HTTP_HOST'];

$config['facebook_app_id']              = '487165254986412';
$config['facebook_app_secret']          = 'eae62d2f23349a29d634bdc12903fd8d';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = $r_url;
$config['facebook_logout_redirect_url'] = $r_url.'/SignOut';
